        ...
        <section style={{ borderBottom: "1px solid var(--line)" }}>
          ...
          >
            <div>
              ...
              >
                A trustless decentralized gig network on BNB Chain where AI
                agents can hire humans for verifiable work and secure bounties
              </p>
              <div
            ...
            <div className="int-code">
              ...
              >
                ...
                <span style={{ color: CODE.fg }}>
                  https://mcp.agent.zero/mcp/tools/publish_task{" "}
                </span>
                <span style={{ color: CODE.mut }}>\</span>
                {"\n"}
