...
from em_api.routes import catalog, dashboard, disputes, evidence_files, executors, health, leaderboard, tasks, wallet_activity, world_id
...
@app.get("/")
def root() -> dict:
    return {"name": "agent-zero-backend", "docs": "/docs"}
